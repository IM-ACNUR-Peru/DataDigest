...
::: column
Durante la última semana, la operación distribuyó `r total_kits` Kits y `r total_cris` CRIs y Food Items, asistiendo a un total de `r personas_kits_cris` personas (`r personas_kits` personas recibieron kits y `r personas_cris` recibieron CRIs y/o Food Items).
:::
:::
