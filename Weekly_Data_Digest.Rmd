...
```{r echo=FALSE, warning=FALSE, message=FALSE, fig.align = 'center', results='hide', fig.width=7,fig.height=3.6}
...
Se preparará proximamente una visualización de los flujos observados directamente en este reporte. Para más información, consultar el [dashboard de estadísticas poblacionales](https://app.powerbi.com/links/xEqM6jT2c9?ctid=e5c37981-6664-4134-8a0c-6543d2af80be) (pestaña "Flujos Irregulares").
...
```{r, echo=FALSE, warning = FALSE, message = FALSE,  fig.width=7,fig.height=4.4}
...
ggplot(
  ...
  geom_text(aes(label = Total), colour = "black", size = 5)  +
  labs(
...
```{r, dpi=200, echo=FALSE, warning = FALSE, message=FALSE, fig.align = 'left', fig.width=7,fig.height=3.5}
