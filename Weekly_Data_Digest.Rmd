...
main_2024 <- x_2024$main |> 
  ...
  select("today":"perfil", "tipo_orientacion":"kit_other", "TotalKit":"paisprevio",  "paisdestino", starts_with("cri_dis"), starts_with("kit_dis"), starts_with("qt_kit"), starts_with("qt_cri"), "member_count") |> 
...
nat_data_dtm <- pbi("dtm_national_new_2.json", "Nacional", "Total")
tacna_data_dtm <- pbi("dtm_tacna_new_2.json", "Tacna", "Total")
tumbes_data_dtm <- pbi("dtm_tumbes_new_2.json", "Tumbes", "Total")
puno_data_dtm <- pbi("dtm_puno_new_2.json", "Puno", "Total")

nat_data_dtm_ven <- pbi("dtm_national_VEN.json", "Nacional", "Ven")
tacna_data_dtm_ven <- pbi("dtm_tacna_VEN.json", "Tacna", "Ven")
tumbes_data_dtm_ven <- pbi("dtm_tumbes_VEN.json", "Tumbes", "Ven")
puno_data_dtm_ven <- pbi("dtm_puno_VEN.json", "Puno", "Ven")
...
Cabe resaltar que estas cifras no corresponden necesariamente a las estimaciones del GTRM, que utilizan fuentes adicionales a la DTM.
